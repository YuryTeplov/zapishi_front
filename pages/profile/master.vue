<template>
  <div>
    ...
    <div class="max-w-md mx-auto bg-white rounded p-8 shadow-lg">
        ...
        <div class="mb-4">
            <img src="@/assets/default_avatar.jpg" alt="Изображение пользователя" class="w-32 h-32 object-cover rounded-full mx-auto mb-4">
        </div>
        
        <!-- Форма для отображения личной информации -->
        <div class="mb-4">
        ...
        <div class="mb-4">
            <label class="block text-sm font-medium text-gray-600">Номер телефона:</label>
            <span class="text-lg font-semibold text-gray-800">123-456-7890</span>
        </div>
    ...
    <div
      ...
      <div class="relative overflow-y-auto p-4">
        <div class="mb-4">
            ...
            <input type="text" id="name" name="name" class="w-full border-gray-300 rounded-md p-2" value="John Doe">
        </div>
        
        <div class="mb-4">
            <label for="email" class="block text-sm font-medium text-gray-600">Email:</label>
            <input type="email" id="email" name="email" class="w-full border-gray-300 rounded-md p-2" value="johndoe@example.com">
        </div>
        
        <div class="mb-4">
            <label for="phone" class="block text-sm font-medium text-gray-600">Номер телефона:</label>
            <input type="tel" id="phone" name="phone" class="w-full border-gray-300 rounded-md p-2" value="123-456-7890">
        </div>
      </div>
